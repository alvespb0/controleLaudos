        ...
        <table class="table table-hover align-middle shadow-sm bg-white rounded" id="faixasTable">
            ...
            <tbody>
                ...
                <tr data-id="{{ $faixa->id }}">
                    ...
                    <td class="text-center view-mode">{{ $faixa->preco }}</td>
                    ...
                    <td class="edit-mode d-none" colspan="5">
                        <form class="d-flex gap-2 align-items-center" method="POST" action="{{route('edit.faixa', $faixa->id)}}">
                            ...
                            <input type="number" min=0 step="0.01" name="preco" class="form-control form-control-sm text-center" value="{{ $faixa->preco }}">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('addRowBtn').addEventListener('click', function() {
        ...
        tr.innerHTML = `
            ...
            <td class="text-center"><input type="number" min=0 step="0.01" name="preco" class="form-control form-control-sm"></td>
        ...
        form.addEventListener('submit', function(e) {
            ...
            form.querySelector('input[name="preco"]').value = row.querySelector('input[name="preco"]').value;
            form.submit();
        });
