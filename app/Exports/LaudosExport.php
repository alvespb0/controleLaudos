    ...
    WithEvents
{
    ...
    public function map($laudo): array
    {
        return [
            ...
            optional($laudo->tecnicoLevantamento())->tecnico->usuario ?? 'N/A',
            optional($laudo->responsavelDigitacao())->tecnico->usuario ?? 'N/A',
            optional($laudo->engenheiroResponsavel())->tecnico->usuario ?? 'N/A',
    ...
    public function headings(): array
    {
        return [
            ...
            'Técnico Responsável Pela digitação',
